...
def energy_balance_model_iterative(aice, frac_sc, sc, K, tcrit, B, A, a, max_iterations=500, tolerance=Decimal("0.0000000001")):
    """
    ...
    # Convert parameters to Decimal if they aren't already
    ...
    return final_t, final_a, global_mean_temp_final, all_temps, r_in_list, r_out_list, f_i_list, all_tcos, r_in_1_a_list, balance_list, init_a, convergence_status, iteration + 1
...
def run_ebm_model(aice, frac_sc, sc, K, tcrit, B, A, a, n_iter, plot_types, precision=2):
    ...
    try:
        ...
        final_t, final_a, global_mean_temp_final, all_temps, r_in_list, r_out_list, f_i_list, all_tcos, r_in_1_a_list, balance_list, init_a_final, convergence_status, actual_iterations = energy_balance_model_iterative(
            aice, frac_sc, sc, K, tcrit, B, A, a, max_iterations=n_iter, tolerance=Decimal("0.0000000001")
        )
        ...
        convergence_display = f"收斂狀態: {convergence_status}"
        ...
        return df, fig, global_temp_display, convergence_display, iter_df
    ...
    **Absorbed Solar Radiation = Outgoing Longwave Radiation**
    ...
    with gr.Row():
        ...
        with gr.Column(scale=7):
            ...
            # Global Temperature and Convergence Status - Side by Side
            with gr.Row():
                ...
                with gr.Column(scale=1):
                    with gr.Group():
                        gr.Markdown("### 收斂狀態")
                        convergence_output = gr.Markdown(value="收斂狀態: --", elem_classes=["convergence-status"])
    ...
    run_button.click(
        ...
        outputs=[dataframe_output, plot_output, global_temp_output, convergence_output, iter_output]
    )
